...
//            if (nList.size != (oList.size + 1)) return@setOnClickListener
        ...
        memo.setOnClickListener {
            when (trig%3) {
                0 -> memo1.text = "${formula.text}"
                1 -> memo2.text = "${formula.text}"
                else -> memo3.text = "${formula.text}"
            }
            trig++
        }
        ...
        clear1.setOnClickListener { memo1.text = "MEMO1"}
        clear2.setOnClickListener { memo2.text = "MEMO2"}
        clear3.setOnClickListener { memo3.text = "MEMO3"}
